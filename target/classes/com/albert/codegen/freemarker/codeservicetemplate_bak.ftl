...
import com.manfen.modules.app.entity.ViewProperty;
import com.manfen.modules.app.wfm.bean.WriteFieldBase;
import com.manfen.modules.app.ViewIndex;
import com.mfh.comn.logic.SeqInit.SeqArea;
import java.util.List;
import java.util.Map;
import org.springframework.transaction.annotation.Transactional;
import com.manfen.modules.app.service.IServiceFilter;
import com.manfen.modules.app.service.impl.IdServiceFilter;
<#if _haveFileField = "1">
...
import com.manfen.modules.service.AbstractService;
 ...
 */
@Component
public class ${_servicename} extends AbstractService<${_cname}, ${obj.pkJavaType}, ${_daoname}> <#if _haveFileField = "1">implements IFileSupportService<${_cname}, ${obj.pkJavaType}></#if> <#if _haveMixField = "1">,IMixFileService</#if>{
	@Autowired
	...
	public ${_servicename}() {
        ...
        ViewIndex.putService(VIEW_${_cuname}, this);, ViewIndex.TOPIC_BASE
		<#if _haveFileField = "1">
    ...
    protected void initServiceFilters(List<IServiceFilter> filters) {    
        filters.add(new IdServiceFilter<${_cname}, ${obj.pkJavaType}>(tableName, SeqArea.thousand));
		<#if _haveFileField = "1">
